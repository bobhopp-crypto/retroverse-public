...
export function integratedQrZonePrompt(): string {
  return [
    ...
    `DECORATIVE GRAPHICS MUST NOT OVERLAP THE QR SAFE AREA — keep the white square completely clear.`,
    `Do NOT draw a second QR placeholder, fake barcode, or duplicate matrix anywhere on the back.`,
    ``,
