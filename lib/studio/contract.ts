...
> = {
  collector: {
    ...
    mission: "Expand the Retrograph — collect facts, sources, media, and relationships; never delete information.",
    inputs: [],
    outputs: ["collector", "visual-identity", "song-dna", "retrograph"],
    ownedArtifacts: ["collector", "visual-identity", "song-dna", "retrograph"],
    dependsOn: [],
  ...
  editor: {
    ...
    mission: "Refine the Retrograph — normalize, dedupe, score confidence, resolve conflicts; never reduce for presentation.",
    inputs: ["collector", "retrograph"],
    outputs: ["editor", "director-handoff", "retrograph"],
    ownedArtifacts: ["editor", "director-handoff", "retrograph"],
    dependsOn: ["collector"],
  ...
  director: {
    ...
    mission: "Read the Retrograph and design experiences from it — never edit or destroy knowledge.",
    inputs: ["director-handoff", "retrograph"],
  ...
  publisher: {
    ...
    mission: "Publish experiences generated from the Retrograph — never edit knowledge or filter facts.",
    inputs: ["director", "director-render-spec", "retrograph", "intelligence"],
    outputs: [],
    ownedArtifacts: [],
