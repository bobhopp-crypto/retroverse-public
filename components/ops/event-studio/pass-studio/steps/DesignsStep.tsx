...
import type { NewPassTemplateInput } from "@/app/ops/event-studio/create/pass-generator/actions";
...
/** Step 2 — review the pass designs Producer already set up. No form fields required. */
export function DesignsStep({
  ...
  return (
    <div className="ps-step">
      ...
      <h2 className="ps-step__title">Pass Designs</h2>
      <p className="ps-step__hint">From Producer — ready to print. Uncheck any design you don&apos;t need.</p>
      ...
      {showAdvanced ? (
        <div className="ps-admin-panel">
          ...
          <p className="ps-step__hint">
            Most events never need this — the designs above already come from Producer.
          </p>
