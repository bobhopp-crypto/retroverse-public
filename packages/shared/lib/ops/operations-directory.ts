...
export const OPS_DIRECTORY_SECTIONS: OpsDirectorySection[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        description: "Manage permanent pass registrations (same claim model as /pass/[serial]).",
        purpose: "Search, edit, reset, and delete registrations in retroverse_passes / visitors.",
        status: "SUNDAY NIGHTS",
      },
      {
        id: "year-match",
