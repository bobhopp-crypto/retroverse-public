...
export const RV_REGISTRY: readonly RvRegistryEntry[] = [
  ...
  e("RV01-03", "RV01", "Broadcast Mixer", "/bobos/broadcast", "Legacy on-air control surface (pre-Booth).", "Cockpit", { panelType: "broadcast" }),
  e("RV01-20", "RV01", "The Booth", "/bobos/booth", "Live production environment — Broadcast Mixer faceplate.", "Cockpit", { navId: "booth" }),
