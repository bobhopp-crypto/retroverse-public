...
export const RV_REGISTRY: readonly RvRegistryEntry[] = [
  e("RV00-00", "RV00", "Retroverse", null, "Platform cold-start entrypoint.", "Platform", { status: "Active" }),
  ...
  e("RV01-03", "RV01", "Broadcast Mixer", "/bobos/broadcast", "On-air control surface.", "Cockpit", { panelType: "broadcast" }),
  ...
  e("RV02-02", "RV02", "Event Producer", "/bobos/producer", "Event production workspace.", "Events", { navId: "producer" }),
  ...
  e("RV02-04", "RV02", "Pass Registrations", "/ops/pass-registrations", "Pass registration administration.", "Events", { panelType: "pass-registration" }),
  e("RV02-05", "RV02", "Legacy Event Tools", "/ops/event-studio", "Legacy event tooling.", "Events", { status: "Deprecated", panelType: "event-studio" }),
