...
export const RV_REGISTRY: readonly RvRegistryEntry[] = [
  ...
  e("RV06-01", "RV06", "Media Lab", "/bobos/media-lab", "Media workspace.", "Media", { panelType: "media-library" }), e("RV06-02", "RV06", "Graph Bridge", "/ops/graph-bridge", "Read-only song-to-album relationship workspace.", "Graph Bridge", { panelType: "graph-bridge", navId: "graph-bridge" }), e("RV06-03", "RV06", "Cover Review", "/ops/review/covers", "Cover review.", "Media"),
