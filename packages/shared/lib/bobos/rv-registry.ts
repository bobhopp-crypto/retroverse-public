...
export const RV_REGISTRY: readonly RvRegistryEntry[] = [
  ...
  e("RV01-21", "RV01", "Song Requests", "/bobos/jukebox", "Retired — redirects to RV01-23 Video Jukebox.", "Cockpit", { status: "Retired", panelEligible: false, cockpitEligible: false }),
  e("RV01-23", "RV01", "Video Jukebox", "/bobos/jukebox", "Shared local and public guest request control with automatic VirtualDJ list insertion.", "Cockpit", { panelType: "video-jukebox", status: "Active" }),
  ...
  e("RV04-04", "RV04", "Media Coverage", "/bobos/virtualdj-media-coverage", "Billboard-to-VirtualDJ audio and video coverage.", "AI", { panelType: "media-coverage", status: "Active" }),
  ...
  e("RV06-01", "RV06", "Media Lab", "/bobos/media-lab", "Media workspace.", "Media", { panelType: "media-library" }),
  e("RV06-02", "RV06", "Graph Bridge", "/ops/graph-bridge", "Read-only song-to-album relationship workspace.", "Graph Bridge", { panelType: "graph-bridge", navId: "graph-bridge" }),
  e("RV06-03", "RV06", "Cover Review", "/ops/review/covers", "Cover review.", "Media"),
  e("RV06-05", "RV06", "Video Downloader", "/bobos/video-downloader", "Paste a YouTube URL and save a 720p MP4 to the Mac Downloads folder.", "Media", { panelType: "video-downloader", status: "Active" }),
