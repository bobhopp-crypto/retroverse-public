...
export function configFromEditorDraft(
  ...
  const payload: EventControlSavePayload = {
    ...
    homepage: {
      ...
      heroOverride: base.homepage.heroOverride,
      panelA: base.homepage.panelA,
      panelB: base.homepage.panelB,
      chyronOverride: base.homepage.chyronOverride,
      idleChyron: base.homepage.idleChyron,
      requests: base.homepage.requests,
      requestProgrammingByEvent: base.homepage.requestProgrammingByEvent,
    },
    rvbr: {
