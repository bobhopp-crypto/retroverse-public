...
/**
 * Local Studio mirror of the patron broadcast-media route.
 * Reads from RETROVERSE_DATA — no ops PIN required so <img> tags load
 * while the operator is in the Broadcast Mixer.
 */
