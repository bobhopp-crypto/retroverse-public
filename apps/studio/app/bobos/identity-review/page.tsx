...
import { loadIdentityReviewQueue } from "@/lib/bobos/identity-review-store";
import { isOpsEnabled } from "@/lib/ops/ops-gate";
import "./identity-review.css";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "Identity Review — BobOS", robots: { index: false, follow: false } };
